...
namespace Server.Data
{
    ...
    public class CopyTeamData
    {
        public CopyTeamData SimpleClone()
        {
			...
			simple.AverageZhanLi = CalAverageZhanLi();

            return simple;
        }

		public int CalAverageZhanLi()
		{
			...
			{
				allZhanLi += TeamRoles[i].CombatForce;
				count++;
			}
			AverageZhanLi = 0;
			if (count != 0)
			{
				AverageZhanLi = (int)(allZhanLi / count);
			}
			return AverageZhanLi;
		}
        /// <summary>
        /// 队伍流水ID
        /// </summary>
