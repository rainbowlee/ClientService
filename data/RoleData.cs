...
namespace Server.Data
{
    ...
    public class RoleData
    {
        ...
        /// <summary>
        /// 任务坐骑ID，供前端显示 [8/4/2014 zhanglin]
        /// 如果人物坐骑ID的值不等于-1，表示该玩家骑上坐骑
        /// </summary>
        [ProtoMember(129)]
        public int TaskHorseID = -1;

        /// <summary>
        /// 元素数据
        /// </summary>
        [ProtoMember(130)]
        public List<ElementCData> ElementData = null;
        ...
        /// </summary>
        [ProtoMember(132)]
        public int ElementPoint = 0;

        /// <summary>
        /// 精灵数据
        /// </summary>
        [ProtoMember(133)]
        public List<JingLingCData> JingLingDatas = null;

        /// <summary>
        /// 师徒设置
        /// </summary>
        [ProtoMember(134)]
        public int SchoolSetting = 0;

        /// <summary>
        /// 法宝数据
        /// </summary>
        [ProtoMember(135)]
        public TrumpData MyTrumpData = null;
