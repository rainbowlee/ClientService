...
namespace Server.Data
{
    ...
    public class BangHuiItemData
    {
        ...
        /// <summary>
        /// 联盟冻结资金 [11/23/2015 zhanglin]
        /// </summary>
        [ProtoMember(12)]
        public int FrozenMoney = 0;

        /// <summary>
        /// 竞拍时间 [11/23/2015 zhanglin]
        /// </summary>
        [ProtoMember(13)]
        public long AuctionTime = 0L;

        /// <summary>
        /// 冻结资金生效时间
        /// </summary>
        [ProtoMember(14)]
        public long FrozenStartTime = 0L;

        /// <summary>
        /// 冻结资金失效时间
        /// </summary>
        [ProtoMember(15)]
        public long FrozenEndTime = 0L;
    }
}
