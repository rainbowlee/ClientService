            ...
            if (!string.IsNullOrEmpty(awardsString))
            {
                ...
                for (int i = 0; i < strFields.Length; ++i)
                {
                    ...
                    if (strGoods.Length == 7)
                    {
                        ...
                        awardsItemData.GoodsID = Convert.ToInt32(strGoods[0]);
                        awardsItemData.GoodsNum = Convert.ToInt32(strGoods[1]);
                        awardsItemData.Binding = Convert.ToInt32(strGoods[2]);
                        awardsItemData.Level = Convert.ToInt32(strGoods[3]);
                        awardsItemData.AppendLev = Convert.ToInt32(strGoods[4]);
                        awardsItemData.IsHaveLuckyProp = Convert.ToInt32(strGoods[5]);
                        awardsItemData.ExcellencePorpValue = Convert.ToInt32(strGoods[6]);
                        awardsItemData.EndTime = "1900-01-01 12:00:00"; 
